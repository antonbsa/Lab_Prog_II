...
public class SequentialList {
    ...
    /* Retorna o elemento na posi��o especificada.  */
    public Object get (int index){
        if (index<0 || index>last) return null;
        else return list[index];
    }
    
    /* Retorna true se o elemento foi inserido no final da lista, false caso contr�rio. */
    ...
    /* Retorna true se o elemento foi inserido na lista, false caso contr�rio.
     * Insere o elemento na posi��o especificada */
    ...
    /* Remove o elemento na posi��o especificada */ 
    ...
    /* Verifica se a lista est� vazia: n�o tel elementos */
    public boolean isEmpty (){
        if (last==-1) return true;
        else return false;
     }
     
    /* Verifica se a lista est� cheia: todas as posi��es da array interna ocupadas */
